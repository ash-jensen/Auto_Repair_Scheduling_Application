...
/**
 * This class makes User objects and includes getters/setters for id, name, and password, and a toString() override.
 *
...
public class User {
    ...
    /**
     * This is the User constructor method with id, name, and password.
